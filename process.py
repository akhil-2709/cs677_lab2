...
def handle_process_start(ops, current_peer_obj: Peer, network_map: Dict[str, Peer]):
    ...
    if current_peer_obj.type == PeerType.BUYER:
        ...
        while True:
            ...
            current_item = network_dict[current_peer_obj.id]['item']
           # current_item = current_peer_obj.item
            ...
            try:
                ...
                network_dict[current_peer_obj.id]['lamport'] +=1
                #current_peer_obj.lamport = current_peer_obj.lamport + 1
                LOGGER.info(f"Incrementing buyer clock: {network_dict[current_peer_obj.id]['lamport']t}")

                trader_id = network_dict[current_peer_obj.id]['trader']
